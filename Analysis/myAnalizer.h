...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<double>  *Muon_nLostHitsInner;
   vector<double>  *Muon_nLostHitsOuter;
   vector<double>  *Muon_nLostHitsOn;
   vector<double>  *Muon_nLostLayersInner;
   vector<double>  *Muon_nLostLayersOuter;
   vector<double>  *Muon_nLostLayersOn;
   ...
   vector<double>  *Muon_match1_dX;
   vector<double>  *Muon_match1_pullX;
   vector<double>  *Muon_match1_pullDxDz;
   vector<double>  *Muon_match1_dY;
   vector<double>  *Muon_match1_pullY;
   vector<double>  *Muon_match1_pullDyDz;

   vector<double>  *Muon_match2_dX;
   vector<double>  *Muon_match2_pullX;
   vector<double>  *Muon_match2_pullDxDz;
   vector<double>  *Muon_match2_dY;
   vector<double>  *Muon_match2_pullY;
   vector<double>  *Muon_match2_pullDyDz;
   ...
   TBranch        *b_Muon_nLostHitsInner;
   TBranch        *b_Muon_nLostHitsOuter;
   TBranch        *b_Muon_nLostHitsOn;
   TBranch        *b_Muon_nLostLayersInner;
   TBranch        *b_Muon_nLostLayersOuter;
   TBranch        *b_Muon_nLostLayersOn;
   ...
   TBranch        *b_Muon_match1_dX;
   TBranch        *b_Muon_match1_pullX;
   TBranch        *b_Muon_match1_pullDxDz;
   TBranch        *b_Muon_match1_dY;
   TBranch        *b_Muon_match1_pullY;
   TBranch        *b_Muon_match1_pullDyDz;

   TBranch        *b_Muon_match2_dX;
   TBranch        *b_Muon_match2_pullX;
   TBranch        *b_Muon_match2_pullDxDz;
   TBranch        *b_Muon_match2_dY;
   TBranch        *b_Muon_match2_pullY;
   TBranch        *b_Muon_match2_pullDyDz;
...
void myAnalizer::Init(TTree *tree)
{
   ...
   Muon_nLostHitsInner = 0;
   Muon_nLostHitsOuter = 0;
   Muon_nLostHitsOn = 0;
   Muon_nLostLayersInner = 0;
   Muon_nLostLayersOuter = 0;
   Muon_nLostLayersOn = 0;
   Muon_outerTrack_p = 0;
   ...
   Muon_match1_dX = 0;
   Muon_match1_pullX = 0;
   Muon_match1_pullDxDz = 0;
   Muon_match1_dY = 0;
   Muon_match1_pullY = 0;
   Muon_match1_pullDyDz = 0;

   Muon_match2_dX = 0;
   Muon_match2_pullX = 0;
   Muon_match2_pullDxDz = 0;
   Muon_match2_dY = 0;
   Muon_match2_pullY = 0;
   Muon_match2_pullDyDz = 0;
   Muon_emEt03 = 0;
   Muon_hadEt03 = 0;
   Muon_nJets03 = 0;
   Muon_nTracks03 = 0;
   ...
   fChain->SetBranchAddress("Muon_nLostHitsInner", &Muon_nLostHitsInner, &b_Muon_nLostHitsInner); 
   fChain->SetBranchAddress("Muon_nLostHitsOuter", &Muon_nLostHitsOuter, &b_Muon_nLostHitsOuter); 
   fChain->SetBranchAddress("Muon_nLostHitsOn",    &Muon_nLostHitsOn,    &b_Muon_nLostHitsOn);    
   fChain->SetBranchAddress("Muon_nLostLayersInner", &Muon_nLostLayersInner, &b_Muon_nLostLayersInner); 
   fChain->SetBranchAddress("Muon_nLostLayersOuter", &Muon_nLostLayersOuter, &b_Muon_nLostLayersOuter); 
   fChain->SetBranchAddress("Muon_nLostLayersOn",    &Muon_nLostLayersOn,    &b_Muon_nLostLayersOn);    
   ...
   fChain->SetBranchAddress("Muon_match1_dX",      &Muon_match1_dX,        &b_Muon_match1_dX);         
   fChain->SetBranchAddress("Muon_match1_pullX",   &Muon_match1_pullX,     &b_Muon_match1_pullX);      
   fChain->SetBranchAddress("Muon_match1_pullDxDz",&Muon_match1_pullDxDz,  &b_Muon_match1_pullDxDz);
   fChain->SetBranchAddress("Muon_match1_dY",      &Muon_match1_dY,        &b_Muon_match1_dY);     
   fChain->SetBranchAddress("Muon_match1_pullY",   &Muon_match1_pullY,     &b_Muon_match1_pullY);  
   fChain->SetBranchAddress("Muon_match1_pullDyDz",&Muon_match1_pullDyDz,  &b_Muon_match1_pullDyDz);
                                                                                                   
   fChain->SetBranchAddress("Muon_match2_dX",      &Muon_match2_dX,        &b_Muon_match2_dX);            
   fChain->SetBranchAddress("Muon_match2_pullX",   &Muon_match2_pullX,     &b_Muon_match2_pullX);       
   fChain->SetBranchAddress("Muon_match2_pullDxDz",&Muon_match2_pullDxDz,  &b_Muon_match2_pullDxDz);
   fChain->SetBranchAddress("Muon_match2_dY",      &Muon_match2_dY,        &b_Muon_match2_dY);             
   fChain->SetBranchAddress("Muon_match2_pullY",   &Muon_match2_pullY,     &b_Muon_match2_pullY);        
   fChain->SetBranchAddress("Muon_match2_pullDyDz",&Muon_match2_pullDyDz,  &b_Muon_match2_pullDyDz);   
