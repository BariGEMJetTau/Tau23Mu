...
void myAnalizer::Loop_Tau3mu(TString type, TString datasetName)
{
    ...
    double nValidTrackerHits1=0, nValidTrackerHits2=0, nValidTrackerHits3=0;
    double trkValidFrac1=0, trkValidFrac2=0,trkValidFrac3=0;
    double nLostHitsInner1=0, nLostHitsOuter1=0, nLostHitsOn1=0; 
    double nLostHitsInner2=0, nLostHitsOuter2=0, nLostHitsOn2=0; 
    double nLostHitsInner3=0, nLostHitsOuter3=0, nLostHitsOn3=0;
    double nLostLayersInner1=0, nLostLayersOuter1=0, nLostLayersOn1=0; 
    double nLostLayersInner2=0, nLostLayersOuter2=0, nLostLayersOn2=0; 
    double nLostLayersInner3=0, nLostLayersOuter3=0, nLostLayersOn3=0;
    ...
    // Creation of the output file
        ...
        TreeFin_Init(tree, isMC, lumi_n, run_n, evt_n, pileupFactor, category, L1_DoubleMu0_er1p5, L1_DoubleMu0_er1p4, L1_DoubleMu4_dR1p2, L1_DoubleMu4p5_dR1p2, L1_DoubleMu0_er2p0, L1_DoubleMu0_er2p0_bk, L1_TripleMu_5SQ_3SQ_0, L1_TripleMu_5SQ_3SQ_0OQ, L1_TripleMu_3SQ_2p5SQ_0OQ_Mass_Max12, L1_TripleMu_2SQ_1p5SQ_0OQ_Mass_Max12, L1seed, HLTpath, deltaR_max, deltaZ_max, Pmu3, cLP, tKink, segmComp, tripletMass, tripletMassReso, fv_nC, fv_dphi3D, fv_d3D,  fv_d3Dsig, d0, nVtx, d0sig, MVA1, MVA2, MVA3, MVASoft1, MVASoft2, MVASoft3,  d0sig_max, mindca_iso, trkRel, Pmu1, Ptmu1, etamu1, phimu1, Pmu2, Ptmu2, etamu2, phimu2, Ptmu3, etamu3, phimu3, P_trip, Pt_trip, eta_trip, nStationsMu1, nStationsMu2, nStationsMu3, Iso03Mu1, Iso03Mu2, Iso03Mu3, Iso05Mu1, Iso05Mu2, Iso05Mu3, nMatchesMu1, nMatchesMu2, nMatchesMu3, timeAtIpInOutMu_sig1, timeAtIpInOutMu_sig2, timeAtIpInOutMu_sig3, cQ_uS, cQ_tK, cQ_gK, cQ_tRChi2, cQ_sRChi2, cQ_Chi2LP, cQ_Chi2LM, cQ_lD, cQ_gDEP, cQ_tM, cQ_gTP, calEn_emMu1, calEn_emMu2, calEn_emMu3, calEn_hadMu1, calEn_hadMu2, calEn_hadMu3, caloComp, fliDistPVSV_Chi2, isGlb1, isTracker1, isLoose1, isSoft1, isPF1, isRPC1, isSA1, isCalo1, isGlb2, isTracker2, isLoose2, isSoft2, isPF2, isRPC2, isSA2, isCalo2, isGlb3, isTracker3, isLoose3, isSoft3, isPF3, isRPC3, isSA3, isCalo3, vx1, vx2, vx3, vy1, vy2, vy3, vz1, vz2, vz3, Refvx1, Refvx2, Refvx3, Refvy1, Refvy2, Refvy3, Refvz1, Refvz2, Refvz3, SVx, SVy, SVz, had03, had05, nJets03, nJets05, nTracks03, nTracks05, sumPt03, sumPt05, hadVeto03, hadVeto05, emVeto03, emVeto05, trVeto03, trVeto05, EnMu1, EnMu2, EnMu3, ChargeMu1, ChargeMu2, ChargeMu3, isHP1, isQValid1, isTValid1, isIsoValid1, GLnormChi2_mu1, GL_nValidMuHits1, trkLayersWMeas1, trkValidFrac1, nValidPixelHits1, nValidTrackerHits1, nLostHitsInner1, nLostHitsOuter1, nLostHitsOn1, nLostLayersInner1, nLostLayersOuter1, nLostLayersOn1, outerTrk_P_1, outerTrk_Eta_1, outerTrk_normChi2_1, outerTrk_muStValidHits_1, innerTrk_P_1, innerTrk_Eta_1, innerTrk_normChi2_1, QInnerOuter_1, cQ_uS_1, cQ_tK_1, cQ_gK_1, cQ_tRChi2_1, cQ_sRChi2_1, cQ_Chi2LP_1, cQ_Chi2LM_1, cQ_lD_1, cQ_gDEP_1, cQ_tM_1, cQ_gTP_1, segmComp_1, caloComp_1, match1_dX_1, match1_pullX_1, match1_pullDxDz_1, match1_dY_1, match1_pullY_1, match1_pullDyDz_1, match2_dX_1, match2_pullX_1, match2_pullDxDz_1, match2_dY_1, match2_pullY_1, match2_pullDyDz_1, isHP2, isQValid2, isTValid2, isIsoValid2, GLnormChi2_mu2, GL_nValidMuHits2, trkLayersWMeas2, trkValidFrac2, nValidPixelHits2, nValidTrackerHits2, nLostHitsInner2, nLostHitsOuter2, nLostHitsOn2, nLostLayersInner2, nLostLayersOuter2, nLostLayersOn2, outerTrk_P_2, outerTrk_Eta_2, outerTrk_normChi2_2, outerTrk_muStValidHits_2, innerTrk_P_2, innerTrk_Eta_2, innerTrk_normChi2_2, QInnerOuter_2, cQ_uS_2, cQ_tK_2, cQ_gK_2, cQ_tRChi2_2, cQ_sRChi2_2, cQ_Chi2LP_2, cQ_Chi2LM_2, cQ_lD_2, cQ_gDEP_2, cQ_tM_2, cQ_gTP_2, segmComp_2, caloComp_2, match1_dX_2, match1_pullX_2, match1_pullDxDz_2, match1_dY_2, match1_pullY_2, match1_pullDyDz_2, match2_dX_2, match2_pullX_2, match2_pullDxDz_2, match2_dY_2, match2_pullY_2, match2_pullDyDz_2, isHP3, isQValid3, isTValid3, isIsoValid3, GLnormChi2_mu3, GL_nValidMuHits3, trkLayersWMeas3, trkValidFrac3, nValidPixelHits3, nValidTrackerHits3, nLostHitsInner3, nLostHitsOuter3, nLostHitsOn3, nLostLayersInner3, nLostLayersOuter3, nLostLayersOn3, outerTrk_P_3, outerTrk_Eta_3, outerTrk_normChi2_3, outerTrk_muStValidHits_3, innerTrk_P_3, innerTrk_Eta_3, innerTrk_normChi2_3, QInnerOuter_3, cQ_uS_3, cQ_tK_3, cQ_gK_3, cQ_tRChi2_3, cQ_sRChi2_3, cQ_Chi2LP_3, cQ_Chi2LM_3, cQ_lD_3, cQ_gDEP_3, cQ_tM_3, cQ_gTP_3, segmComp_3, caloComp_3, match1_dX_3, match1_pullX_3, match1_pullDxDz_3, match1_dY_3, match1_pullY_3, match1_pullDyDz_3, match2_dX_3, match2_pullX_3, match2_pullDxDz_3, match2_dY_3, match2_pullY_3, match2_pullDyDz_3,dimu_OS1, dimu_OS2);
    ...
    for (Long64_t jentry=0; jentry<nentries;jentry++) {
	    ...
	    //cout << "HLT path: "<< hltName << " | decision: " << Trigger_hltdecision->at(h) << endl;
            if( hltName.Contains("HLT_DoubleMu4_3_LowMass") && Trigger_hltdecision->at(h) == 1){
        ...
        for (int j=0; j<TripletVtx_Chi2->size(); j++){
            ...
            if(!(abs(Mu1_Eta->at(j))<=2.4 && abs(Mu2_Eta->at(j))<=2.4 && abs(Mu3_Eta->at(j))<=2.4)) continue;
            if(!(Mu1_Pt->at(j)>=2 && Mu2_Pt->at(j)>=2 && Mu3_Pt->at(j)>=2)) continue;
            ...
            //!!!!!! changed to Loose
            if( (Muon_isGlobal->at(mu[0]) || Muon_isTrackerMuon->at(mu[0]) ) && (Muon_isGlobal->at(mu[1]) || Muon_isTrackerMuon->at(mu[1]) ) && (Muon_isGlobal->at(mu[2]) || Muon_isTrackerMuon->at(mu[2]) ) ) 
            ...
            // combinations including 3mu HLT
            if(HLTpath==1 || HLTpath==11 || HLTpath==101 || HLTpath==111){
                ...
                if(HLTpath>=100){ //combinations including Dimuon_displaced
            ...
            //for dimuon, we set mu3 matching by default
